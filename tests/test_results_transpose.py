...
from miu_db.domains.results.ui.mixins.results import (
    MAX_TRANSPOSE_ROWS,
    ResultsMixin,
...
class TestTransposeRegistration:
    def test_keymap_registers_t_for_transpose(self) -> None:
        from miu_db.core.keymap import DefaultKeymapProvider
    ...
    def test_results_focused_state_registers_transpose(self) -> None:
        from miu_db.domains.results.state.results_focused import ResultsFocusedState
