...
class TestTunnelManualPath:
    ...
    def test_manual_path_unchanged(self):
        ...
        from miu_db.domains.connections.domain.config import ConnectionConfig, TcpEndpoint, TunnelConfig
...
class TestTunnelConfigMode:
    ...
    def test_alias_direct_no_proxyjump(self):
        ...
        with mock.patch("sshtunnel.SSHTunnelForwarder") as MockForwarder:
            ...
            with mock.patch("miu_db.domains.connections.app.ssh_config.resolve") as mock_resolve:
                from miu_db.domains.connections.app.ssh_config import AliasInfo
    ...
    def test_chained_tunnel_stop_order(self):
        ...
        from miu_db.domains.connections.app.tunnel import ChainedTunnel
    ...
    def test_alias_missing_raises_not_found(self):
        ...
        with mock.patch("miu_db.domains.connections.app.ssh_config.resolve") as mock_resolve:
            from miu_db.domains.connections.app.ssh_config import SSHAliasNotFoundError
