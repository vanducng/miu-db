...
MARIADB_CHARSET_DATABASE = os.environ.get("MARIADB_CHARSET_DATABASE", "test_miu_db")
...
def mariadb_tis620_connection(mariadb_tis620_db: str) -> str:
    """Create a miu-db CLI connection for MariaDB TIS-620."""
...
def mariadb_latin1_connection(mariadb_latin1_db: str) -> str:
    """Create a miu-db CLI connection for MariaDB Latin1."""
