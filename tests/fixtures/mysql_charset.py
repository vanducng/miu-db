...
MYSQL_CHARSET_DATABASE = os.environ.get("MYSQL_CHARSET_DATABASE", "test_miu_db")
...
def mysql_tis620_connection(mysql_tis620_db: str) -> str:
    """Create a miu-db CLI connection for MySQL TIS-620."""
...
def mysql_latin1_connection(mysql_latin1_db: str) -> str:
    """Create a miu-db CLI connection for MySQL Latin1."""
