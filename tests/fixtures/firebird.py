...
FIREBIRD_DATABASE = os.environ.get("FIREBIRD_DATABASE", "/var/lib/firebird/data/test_miu_db.fdb")
...
def firebird_connection(firebird_db: str) -> str:
    """Create a miu-db CLI connection for Firebird and clean up after test."""
