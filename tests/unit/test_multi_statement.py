...
class TestStatementSplitting:
    ...
    def test_splits_simple_statements(self):
        ...
        from miu_db.domains.query.app.multi_statement import split_statements
...
class TestMultiStatementResult:
    ...
    def test_creates_result_with_multiple_items(self):
        ...
        from miu_db.domains.query.app.query_service import NonQueryResult, QueryResult
...
class TestNormalizeSqlForExecution:
    ...
    def test_adds_semicolons_between_blank_line_statements(self):
        ...
        from miu_db.domains.query.app.multi_statement import normalize_for_execution
...
class TestCursorStatementResolution:
    ...
    def test_statement_ranges_cover_multi_line_statements(self):
        from miu_db.domains.query.app.multi_statement import _get_statement_ranges
