"""Text-area related widgets for miu-db."""
...
if TYPE_CHECKING:
    from miu_db.shared.ui.protocols import AutocompleteProtocol
...
class QueryTextArea(TextArea):
    ...
    def _get_insert_cursor_color(self) -> str:
        from miu_db.domains.shell.app.themes import DEFAULT_MODE_COLORS, MODE_NORMAL_COLOR_VAR
    ...
    def _try_dispatch_chord(self, event: Key, normalized_key: str) -> bool:
        ...
        """
        from miu_db.core.action_validation import evaluate_chord_guard
    ...
    def _resolve_active_statement_line_range(self) -> tuple[int, int] | None:
        ...
        from miu_db.domains.query.app.multi_statement import active_statement_line_range
