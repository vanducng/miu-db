...
class ResultsActionsProtocol(Protocol):
    ...
    def _flash_table_yank(self, table: MiuDataTable, scope: str) -> None:
        ...
    ...
    def _get_active_stacked_results_target(self) -> tuple[Any | None, MiuDataTable | None]:
        ...
    ...
    def _get_active_results_context(
        self,
    ) -> tuple[MiuDataTable | None, list[str], list[tuple[Any, ...]], bool]:
        ...
    ...
    def _hide_cell_tooltip(self, table: MiuDataTable) -> None:
        ...

    def _show_cell_tooltip(self, table: MiuDataTable, coordinate: Any, value: Any) -> None:
        ...
