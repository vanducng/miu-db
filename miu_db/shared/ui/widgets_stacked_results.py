...
from .widgets_tables import MiuDataTable

if TYPE_CHECKING:
    from miu_db.domains.query.app.multi_statement import StatementResult
...
class StackedResultsContainer(VerticalScroll):
    ...
    def add_result_section(
        ...
        *,
        ...
        content: MiuDataTable | NonQueryDisplay | ErrorDisplay
