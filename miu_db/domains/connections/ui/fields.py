...
from miu_db.domains.connections.providers.schema_helpers import FieldType, SelectOption

if TYPE_CHECKING:
    from miu_db.domains.connections.providers.schema_helpers import ConnectionSchema, SchemaField
