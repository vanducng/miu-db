...
from miu_db.domains.connections.app.save_connection import is_config_saved, save_connection
from miu_db.domains.connections.discovery.cloud import ProviderState, get_providers
from miu_db.domains.explorer.ui.tree import builder as tree_builder
from miu_db.shared.core.utils import flatten_pasted_text, fuzzy_match
...
class ConnectionPickerScreen(ModalScreen):
    ...
    def action_refresh(self) -> None:
        from miu_db.domains.connections.discovery.cloud.aws.cache import clear_aws_cache
        from miu_db.domains.connections.discovery.cloud.azure.cache import clear_azure_cache
        from miu_db.domains.connections.discovery.cloud.gcp.cache import clear_gcp_cache
