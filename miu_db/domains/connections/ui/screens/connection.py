...
from miu_db.domains.connections.providers.metadata import has_advanced_auth, is_file_based, supports_ssh
from miu_db.domains.connections.ui.connection_focus import ConnectionFocusController
from miu_db.domains.connections.ui.connection_form import ConnectionFormController
from miu_db.domains.connections.ui.connection_test_controller import ConnectionTestController
from miu_db.domains.connections.ui.driver_status_controller import DriverStatusController
from miu_db.domains.connections.ui.restart_cache import clear_restart_cache, write_restart_cache
from miu_db.domains.connections.ui.screens.connection_styles import CONNECTION_SCREEN_CSS
from miu_db.domains.connections.ui.validation import ValidationState, validate_connection_form
from miu_db.domains.connections.ui.validation_ui_binder import ConnectionValidationBinder
...
class ConnectionScreen(ModalScreen):
    ...
    def _on_browse_file(self, field_name: str) -> None:
        ...
        from miu_db.domains.connections.ui.fields import FieldType
