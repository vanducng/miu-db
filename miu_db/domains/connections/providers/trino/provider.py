...
from miu_db.domains.connections.providers.trino.schema import SCHEMA


def _provider_factory(spec: ProviderSpec) -> DatabaseProvider:
    from miu_db.domains.connections.providers.trino.adapter import TrinoAdapter
...
SPEC = ProviderSpec(
    db_type="trino",
    display_name="Trino",
    schema_path=("miu_db.domains.connections.providers.trino.schema", "SCHEMA"),
    supports_ssh=True,
    is_file_based=False,
