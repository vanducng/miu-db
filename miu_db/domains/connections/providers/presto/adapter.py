"""Presto adapter using presto-python-client."""
...
class PrestoAdapter(CursorBasedAdapter):
    """Adapter for PrestoDB using presto-python-client."""
    ...
    def connect(self, config: ConnectionConfig) -> Any:
        prestodb_dbapi = self._import_driver_module(
            "prestodb.dbapi",
        ...
        if endpoint is None:
            raise ValueError("Presto connections require a TCP-style endpoint.")
        port = int(endpoint.port or get_default_port("presto"))
