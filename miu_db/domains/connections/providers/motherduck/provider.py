...
from miu_db.domains.connections.providers.motherduck.schema import SCHEMA
...
def _provider_factory(spec: ProviderSpec) -> DatabaseProvider:
    from miu_db.domains.connections.providers.motherduck.adapter import MotherDuckAdapter
...
SPEC = ProviderSpec(
    ...
    schema_path=("miu_db.domains.connections.providers.motherduck.schema", "SCHEMA"),
    supports_ssh=False,
    is_file_based=False,
