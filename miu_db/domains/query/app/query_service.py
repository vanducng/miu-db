"""Query execution service for miu-db.
...
if TYPE_CHECKING:
    ...
    from miu_db.shared.core.protocols import HistoryStoreProtocol, QueryExecutorProtocol
...
class KeywordQueryAnalyzer:
    def classify(self, query: str) -> QueryKind:
        ...
        """
        from miu_db.domains.query.editing.comments import (
            is_comment_line,
