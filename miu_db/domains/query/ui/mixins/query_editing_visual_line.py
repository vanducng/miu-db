...
class QueryEditingVisualLineMixin:
    ...
    def action_visual_line_yank(self: QueryMixinHost) -> None:
        ...
        from miu_db.domains.query.editing import MotionType, Position, Range, operator_yank
    ...
    def action_visual_line_delete(self: QueryMixinHost) -> None:
        ...
        from miu_db.domains.query.editing import MotionType, Position, Range, operator_delete
        from textual.widgets.text_area import Selection
