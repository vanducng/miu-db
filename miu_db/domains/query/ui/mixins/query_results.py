...
class QueryResultsMixin:
    ...
    def _build_results_table(
        ...
        *,
        ...
        if not columns:
            return MiuDataTable(id=new_id, zebra_stripes=True, show_header=False)
    ...
    def _replace_results_table_with_table(self: QueryMixinHost, table: MiuDataTable) -> None:
    ...
    def _display_multi_statement_results(
        ...
        self._cancel_results_render()
        from miu_db.shared.ui.widgets_stacked_results import (
