...
if TYPE_CHECKING:
    ...
    from miu_db.domains.query.editing.types import Range
...
class QueryEditingSelectionMixin:
    ...
    def _selection_range(
        ...
        from miu_db.domains.query.editing.types import MotionType, Position, Range
    ...
    def _change_selection(self: QueryMixinHost) -> None:
        ...
        from miu_db.domains.query.editing import get_selection_text, operator_delete
