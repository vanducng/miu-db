...
from miu_db.domains.explorer.ui.tree import db_switching as tree_db_switching
from miu_db.domains.process_worker.ui.mixins.process_worker_lifecycle import (
...
if TYPE_CHECKING:
    ...
    from miu_db.domains.query.app.query_service import QueryService
...
class QueryExecutionMixin(ProcessWorkerLifecycleMixin):
    ...
    def _get_query_to_execute(self: QueryMixinHost) -> str:
        ...
        if selection.start != selection.end:
            from miu_db.domains.query.editing import get_selection_text
    ...
    def _maybe_confirm_query(self: QueryMixinHost, query: str, proceed: Callable[[], None]) -> None:
        ...
        from miu_db.domains.query.app.alerts import (
            AlertMode,
            AlertSeverity,
        ...
        from miu_db.domains.query.app.multi_statement import get_executable_sql
    ...
    def _get_unsaved_history_store(self: QueryMixinHost) -> Any:
        ...
        if store is None:
            from miu_db.domains.query.store.memory import InMemoryHistoryStore
    ...
    def _get_query_service(self: QueryMixinHost, provider: Any) -> QueryService:
        if self._query_service is None or (
            ...
            from miu_db.domains.query.app.query_service import DialectQueryAnalyzer, QueryService
    ...
    async def _run_query_async(self: QueryMixinHost, query: str, keep_insert_mode: bool) -> None:
        ...
        from miu_db.domains.query.app.multi_statement import (
            MultiStatementExecutor,
            split_statements,
        )
        from miu_db.domains.query.app.query_service import QueryResult, parse_use_statement
        from miu_db.domains.query.app.transaction import is_transaction_end, is_transaction_start
        ...
        from miu_db.domains.query.editing.comments import is_comment_only_statement
    ...
    async def _run_query_atomic_async(self: QueryMixinHost, query: str) -> None:
        ...
        from miu_db.domains.query.app.multi_statement import MultiStatementResult
