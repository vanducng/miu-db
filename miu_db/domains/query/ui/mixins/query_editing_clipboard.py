...
class QueryEditingClipboardMixin:
    ...
    def action_select_all(self: QueryMixinHost) -> None:
        ...
        from miu_db.domains.query.editing import select_all_range
    ...
    def _paste_text(self: QueryMixinHost, clipboard: str) -> None:
        """Paste provided text using the same linewise-aware pipeline as action_paste."""
        from textual.widgets.text_area import Selection

        from miu_db.domains.query.editing import paste_text, paste_text_below
        ...
        selection = self.query_input.selection
        if selection.start != selection.end:
            from miu_db.domains.query.editing import operator_delete
    ...
    def action_paste_line_below(self: QueryMixinHost) -> None:
        ...
        from miu_db.domains.query.editing import paste_text, paste_text_above
    ...
    def _get_clipboard_text(self: QueryMixinHost, prefer_internal: bool = False) -> str:
        ...
        from miu_db.shared.ui.clipboard import get_system_clipboard_text
