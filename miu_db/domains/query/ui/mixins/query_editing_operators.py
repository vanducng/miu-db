...
from miu_db.domains.query.editing import deletion as edit_delete
...
class QueryEditingOperatorsMixin:
    ...
    def _show_text_object_menu(self: QueryMixinHost, mode: str) -> None:
        ...
        from miu_db.domains.query.ui.screens import TextObjectMenuScreen
    ...
    def _delete_with_motion(self: QueryMixinHost, motion_key: str, char: str | None = None) -> None:
        ...
        from miu_db.domains.query.editing import MOTIONS, MotionType, Position, Range, operator_delete
    ...
    def _delete_with_text_object(self: QueryMixinHost, obj_char: str, around: bool) -> None:
        ...
        from miu_db.domains.query.editing import MotionType, get_text_object, operator_delete
    ...
    def _yank_with_motion(self: QueryMixinHost, motion_key: str, char: str | None = None) -> None:
        ...
        from miu_db.domains.query.editing import MOTIONS, MotionType, Position, Range, operator_yank
    ...
    def _yank_with_text_object(self: QueryMixinHost, obj_char: str, around: bool) -> None:
        ...
        from miu_db.domains.query.editing import MotionType, get_text_object, operator_yank
    ...
    def _change_with_motion(self: QueryMixinHost, motion_key: str, char: str | None = None) -> None:
        ...
        from miu_db.domains.query.editing import MOTIONS, MotionType, Position, Range, operator_change
    ...
    def _change_with_text_object(self: QueryMixinHost, obj_char: str, around: bool) -> None:
        ...
        from miu_db.domains.query.editing import MotionType, get_text_object, operator_change
