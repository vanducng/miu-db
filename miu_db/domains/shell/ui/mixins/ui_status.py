...
from miu_db.domains.connections.providers.metadata import get_connection_display_info
from miu_db.shared.ui.protocols import UINavigationMixinHost
...
class UIStatusMixin:
    ...
    def _sync_active_pane_title(self: UINavigationMixinHost) -> None:
        ...
        from miu_db.core.state_base import resolve_display_key
    ...
    def _update_status_bar(self: UINavigationMixinHost) -> None:
        ...
        from miu_db.core.vim import VimMode
        from miu_db.shared.ui.spinner import SPINNER_FRAMES
        ...
        if getattr(self, "query_executing", False):
            ...
            if query_spinner and query_spinner.running:
                ...
                from miu_db.shared.core.utils import format_duration_ms
    ...
    def _update_idle_scheduler_bar(self: UINavigationMixinHost) -> None:
        ...
        from miu_db.domains.shell.app.idle_scheduler import get_idle_scheduler
    ...
    def _update_footer_bindings(self: UINavigationMixinHost) -> None:
        ...
        from miu_db.shared.ui.widgets import ContextFooter, KeyBinding
        from miu_db.core.vim import VimMode
    ...
    def _get_mode_colors(self: UINavigationMixinHost) -> tuple[str, str]:
        from miu_db.domains.shell.app.themes import (
            DEFAULT_MODE_COLORS,
